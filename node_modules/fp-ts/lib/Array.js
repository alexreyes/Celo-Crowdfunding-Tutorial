...
exports.array = {
    ...
    compact: function (as) { return exports.array.filterMap(as, identity); },
    ...
    sequence: function (F) { return function (ta) {
        return exports.array.reduce(ta, F.of(exports.array.zero()), function (fas, fa) { return F.ap(F.map(fas, function (as) { return function (a) { return snoc(as, a); }; }), fa); });
    }; },
