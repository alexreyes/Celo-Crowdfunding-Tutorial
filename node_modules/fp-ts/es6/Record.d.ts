 ...
 * @since 2.0.0
 */
export declare function toUnfoldable<F extends URIS>(unfoldable: Unfoldable1<F>): <K extends string, A>(r: Record<K, A>) => Kind<F, [K, A]>;
 ...
 * @since 2.0.0
 */
export declare function partitionMapWithIndex<K extends string, A, B, C>(f: (key: K, a: A) => Either<B, C>): (fa: Record<K, A>) => Separated<Record<string, B>, Record<string, C>>;
/**
 * @since 2.0.0
 */
 ...
 * @since 2.0.0
 */
export declare function fromFoldable<F extends URIS3, A>(M: Magma<A>, F: Foldable3<F>): <K extends string, R, E>(fka: Kind3<F, R, E, [K, A]>) => Record<K, A>;
export declare function fromFoldable<F extends URIS2, A>(M: Magma<A>, F: Foldable2<F>): <K extends string, E>(fka: Kind2<F, E, [K, A]>) => Record<K, A>;
export declare function fromFoldable<F extends URIS, A>(M: Magma<A>, F: Foldable1<F>): <K extends string>(fka: Kind<F, [K, A]>) => Record<K, A>;
 ...
 * @since 2.0.0
 */
export declare function fromFoldableMap<F extends URIS3, B>(M: Magma<B>, F: Foldable3<F>): <R, E, A, K extends string>(fa: Kind3<F, R, E, A>, f: (a: A) => [K, B]) => Record<K, B>;
export declare function fromFoldableMap<F extends URIS2, B>(M: Magma<B>, F: Foldable2<F>): <E, A, K extends string>(fa: Kind2<F, E, A>, f: (a: A) => [K, B]) => Record<K, B>;
export declare function fromFoldableMap<F extends URIS, B>(M: Magma<B>, F: Foldable1<F>): <A, K extends string>(fa: Kind<F, A>, f: (a: A) => [K, B]) => Record<K, B>;
...
}, partitionMap: <A, B, C>(f: (a: A) => Either<B, C>) => (fa: Record<string, A>) => Separated<Record<string, B>, Record<string, C>>, reduce: <A, B>(b: B, f: (b: B, a: A) => B) => (fa: Record<string, A>) => B, reduceRight: <A, B>(b: B, f: (a: A, b: B) => B) => (fa: Record<string, A>) => B, compact: <A>(fa: Record<string, Option<A>>) => Record<string, A>, separate: <A, B>(fa: Record<string, Either<A, B>>) => Separated<Record<string, A>, Record<string, B>>;
export { 
/**
 * @since 2.0.0
 */
