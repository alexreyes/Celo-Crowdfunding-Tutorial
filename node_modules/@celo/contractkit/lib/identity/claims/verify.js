        ...
        return __generator(this, function (_a) {
            switch (claim.type) {
                ...
                case types_1.ClaimTypes.ACCOUNT:
                    return [2 /*return*/, exports.verifyAccountClaim(kit, claim, address, tries)];
...
exports.verifyAccountClaim = function (kit, claim, address, tries) {
    if (tries === void 0) { tries = 3; }
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.trys.push([3, 5, , 6]);
                    return [4 /*yield*/, metadata_1.IdentityMetadataWrapper.fetchFromURL(kit, metadataURL, tries)];
                case 4:
                    metadata = _a.sent();
                    return [3 /*break*/, 6];
                case 5:
