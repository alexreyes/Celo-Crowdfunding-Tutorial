...
export declare class EscrowWrapper extends BaseWrapper<Escrow> {
    ...
    transfer: (identifier: string | number[], token: string, value: string | number, expirySeconds: string | number, paymentId: string, minAttestations: string | number) => import("@celo/connect").CeloTransactionObject<boolean>;
    withdraw: (paymentId: string, v: string | number, r: string | number[], s: string | number[]) => import("@celo/connect").CeloTransactionObject<boolean>;
    revoke: (paymentId: string) => import("@celo/connect").CeloTransactionObject<boolean>;
}
