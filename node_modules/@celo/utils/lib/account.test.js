...
describe('Mnemonic validation', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    expect(account_2.validateMnemonic(mnemonics[i])).toBeTruthy();
    ...
    it('should generate the same keys for a mnemonic with and without accents', function () { return __awaiter(void 0, void 0, void 0, function () {
        var spanishMnemonics, expectedPrivateKeys, _i, spanishMnemonics_1, mnemonic, derivation0, derivation1, password;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    spanishMnemonics = [
                    ...
                    _i = 0, spanishMnemonics_1 = spanishMnemonics;
                    _a.label = 1;
                case 1:
                    if (!(_i < spanishMnemonics_1.length)) return [3 /*break*/, 6];
                    mnemonic = spanishMnemonics_1[_i];
                    mnemonic = account_2.formatNonAccentedCharacters(mnemonic);
                    expect(account_2.validateMnemonic(mnemonic)).toBeTruthy();
                    return [4 /*yield*/, account_2.generateKeys(mnemonic)];
                case 2:
                    derivation0 = _a.sent();
                    return [4 /*yield*/, account_2.generateKeys(mnemonic, undefined, 0, 1)];
                case 3:
                    derivation1 = _a.sent();
                    return [4 /*yield*/, account_2.generateKeys(mnemonic, 'password')];
                case 4:
                    password = _a.sent();
                    expect({ derivation0: derivation0, derivation1: derivation1, password: password }).toEqual(expectedPrivateKeys);
                    _a.label = 5;
                case 5:
                    _i++;
                    return [3 /*break*/, 1];
    ...
    describe.each(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    lang                                                        | langMnemonic\n    ", "  | ", "\n    ", " | ", "\n    ", "             | ", "\n    ", "              | ", "\n    ", "             | ", "\n    ", "            | ", "\n    ", "              | ", "\n    ", "             | ", "\n    ", "          | ", "\n  "], ["\n    lang                                                        | langMnemonic\n    ", "  | ", "\n    ", " | ", "\n    ", "             | ", "\n    ", "              | ", "\n    ", "             | ", "\n    ", "            | ", "\n    ", "              | ", "\n    ", "             | ", "\n    ", "          | ", "\n  "])), account_1.MnemonicLanguages[account_1.MnemonicLanguages.chinese_simplified], '唐 即 驶 橡 钙 六 码 卸 擦 批 培 拒 磨 励 累 栏 砍 霞 弃 卫 中 空 罩 尘', account_1.MnemonicLanguages[account_1.MnemonicLanguages.chinese_traditional], '微 款 輩 除 雕 將 鑽 蕭 奇 波 掃 齒 弱 誣 氫 兩 證 漸 堡 亦 攝 了 坯 材', account_1.MnemonicLanguages[account_1.MnemonicLanguages.english], 'grid dove lift rib rose grit comfort delay moon crumble sell adapt rule food pull loan puppy okay palace predict grass hint repair napkin', account_1.MnemonicLanguages[account_1.MnemonicLanguages.french], 'texte succès lexique frégate sévir oiseau lanceur souvenir mythique onirique pélican opérer foulure enfouir maintien vexer relief aérer citerne ligoter arbitre gomme sénateur dénouer', account_1.MnemonicLanguages[account_1.MnemonicLanguages.italian], 'leone sinistro nicchia mole tromba celebre parcella pillola golf voga ostacolo relazione peso unificato tristezza brezza merenda trasloco pinolo persuaso querela pomice onere premere', account_1.MnemonicLanguages[account_1.MnemonicLanguages.japanese], 'へきが　けねん　したうけ　せんさい　けいさつ　めんきょ　せりふ　ひびく　せあぶら　たいむ　そこう　うさぎ　つながる　はんろん　むいか　せはば　すべる　りりく　はいれつ　たいる　りかい　さたん　はっかく　ひしょ', account_1.MnemonicLanguages[account_1.MnemonicLanguages.korean], '보장 검사 장기간 문득 먼저 현지 쇼핑 재정 예금 녹화 연세 도덕 정말 불빛 사생활 재능 활동 불빛 경험 소형 고등학생 철저히 공원 증세', account_1.MnemonicLanguages[account_1.MnemonicLanguages.spanish], 'cordón soplar santo teoría arpa ducha secreto margen brisa anciano maldad colgar atún catre votar órgano bebida ecuador rabia maduro tubo faja avaro vivero', account_1.MnemonicLanguages[account_1.MnemonicLanguages.portuguese], 'cheiro lealdade duplo oposto vereador acessar lanche regra prefeito apego ratazana piedade alarme marmita subsolo brochura honrado viajar magnata canoa sarjeta terno cimento prezar')('mnemonic in $lang', function (_a) {
        var lang = _a.lang, langMnemonic = _a.langMnemonic;
        it("should generate a valid mnemonic", function () { return __awaiter(void 0, void 0, void 0, function () {
            var mnemonic;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, account_2.generateMnemonic(undefined, account_1.MnemonicLanguages[lang])];
                    case 1:
                        mnemonic = _a.sent();
                        expect(mnemonic.split(/\s+/g).length).toEqual(24);
        ...
        it("should validate a mnemonic", function () {
            // This validates against all languages
            expect(account_2.validateMnemonic(langMnemonic)).toBeTruthy();
            // This validates using a specific wordlist
